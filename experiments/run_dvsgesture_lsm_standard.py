...
def main():
    ...
    print(f"DVSGesture standard LSM accuracy: {acc * 100:.2f}%")
    ...
    save_results(results, "dvsgesture_lsm_standard.json")
    np.savez(
        PROJECT_ROOT / "results" / "dvsgesture_lsm_standard_predictions.npz",
        y_true=y_test,
        y_pred=preds,
    )
